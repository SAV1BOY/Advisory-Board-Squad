# 02 — Strategy Refresh Cycle

## Overview

A structured process to re-examine the company's strategic position, stress-test existing choices, and produce an updated strategy with measurable commitments. Runs annually as a deep cycle and can be triggered ad-hoc by material shifts in the competitive landscape.

## Trigger

- Annual planning calendar (kicks off Q3 for next fiscal year).
- Material market disruption: new entrant, regulation change, technology shift, macro shock.
- Board effectiveness review reveals strategic drift or stale assumptions.
...
1. Board workshop (half-day session):
   a. Review the diagnostic (30 min).
...
- Strategic diagnostic brief (5 pages).
- Pre-mortem document.
- Strategic choices summary (1 page).
- Strategic plan (3-year direction + 12-month priorities).
- Metrics dashboard with OKRs.
- Cross-squad strategy briefs.
- Archived strategy refresh package.

## Timeline

| Milestone | Week |
|---|---|
| Diagnostic complete | Week 2 |
| Board workshop | Week 3-4 |
| Plan draft circulated | Week 6 |
| Metrics dashboard live | Week 7 |
| Board ratification | Week 8 |
| Communication cascade complete | Week 10 |

## Metrics

| Metric | Target |
|---|---|
| Diagnostic interview completion | 100 % of executive team |
| Strategic questions identified | 3-5 per cycle |
| Options generated per question | ≥3 |
| Plan ratification | Board supermajority (≥75 %) |
| Time from kickoff to ratified plan | ≤10 weeks |
| Assumption checkpoints honored | 100 % reviewed on schedule |
