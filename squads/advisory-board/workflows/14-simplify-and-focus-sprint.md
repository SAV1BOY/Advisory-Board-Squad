# 14 — Simplify & Focus Sprint

## Overview

A time-boxed sprint to ruthlessly eliminate complexity, cut low-value activities, and sharpen organizational focus. Inspired by the principle that what you choose not to do is as important as what you choose to do. This workflow produces measurable reductions in complexity and frees capacity for high-priority work.

## Trigger

- Strategy refresh (workflow 02) identifies focus as a critical issue.
- Org health audit reveals capacity overload or execution fragmentation.
- Board observes too many initiatives for the resources available.
- Quarterly review shows declining execution quality across the board.
- New CEO or executive wants to reset priorities.
...
1. strategic-advisor inventories all active initiatives, projects, products, processes, meetings, and reports:
   ...
   - Value produced (revenue, strategic progress, risk mitigation, learning).
   - Age: how long has this been running?
   - Last time someone questioned whether this should exist.
2. Categorize each item:
   - Core: directly serves the top 3-5 strategic priorities.
   - Support: enables core activities (infrastructure, compliance).
...
1. CEO communicates the simplification initiative to the organization:
   - Why: the strategic rationale for focus.
...
1. growth-navigator measures the impact of simplification:
   ...
   - Decision speed: are decisions happening faster with fewer competing priorities?
2. Check for unintended consequences:
   - Did any killed item turn out to be more important than expected?
   - Did any team lose capabilities they actually needed?
   - Did customers or partners notice any negative impact?
3. Board reviews the impact assessment at the next quarterly meeting.
4. If the sprint was successful, consider making it a recurring event (semi-annual or annual).
5. Archive the sprint package in `archive/simplification-sprints/`.
...
- Initiative inventory with resource consumption and value assessment.
- Complexity tax calculation.
- Cut list with decisions and rationale.
- Communication to the organization.
- Capacity redeployment plan.
- Impact measurement report (30-day and 90-day).

## Timeline

| Milestone | Day |
|---|---|
| Complexity audit complete | Day 7 |
| Cut list approved | Day 12 |
| Communication sent | Day 14 |
| Kill items executed | Day 19 |
| All cuts actioned | Day 30 |
| 30-day impact check | Day 44 |
| 90-day impact report | Day 104 |

## Metrics

| Metric | Target |
|---|---|
| Items audited | 100 % of active initiatives |
| Complexity reduction | ≥20 % of legacy/low-value items killed or sunset |
| Capacity freed | ≥15 % of total capacity redirected to top priorities |
| Execution velocity | ≥20 % improvement in milestone completion rate for top priorities |
| Team workload sustainability | ≥10-point improvement in workload survey scores |
| Unintended consequences | Zero critical items mistakenly killed |
