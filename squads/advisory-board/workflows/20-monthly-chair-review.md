# 20 — Monthly Chair Review

## Overview

The Board Chair's monthly operating rhythm — a structured review of open decisions, active registries, upcoming agenda items, and board health. This is the Chair's personal cadence for staying on top of board operations and ensuring nothing falls through the cracks.

## Trigger

- Monthly calendar (first week of each month).
- This review is non-negotiable. It happens every month regardless of other activities.
...
1. Board-Chair reviews the next board meeting agenda:
   ...
   - Are decision items clearly framed as decisions (not just "discussions")?
2. Review the prior meeting's minutes:
   - Were minutes distributed on time?
   - Are there any corrections or additions needed?
3. Check the 90-day forward calendar:
   - Any scheduling conflicts to resolve.
   - Any upcoming events that will affect the board (fundraise, executive transition, regulatory milestone).
   - Any deadlines approaching (annual review, effectiveness assessment, strategy refresh).

### Phase 2 — Decision Registry Review (30 minutes)

1. Pull the decision log. Review all decisions from the past 90 days:
   - Are all decisions properly recorded with rationale, dissent, and review dates?
   - Any decisions approaching their review date?
   - Any decisions that have produced outcomes worth noting?
2. For decisions approaching review:
   - Schedule the review in the appropriate meeting.
   - Notify the decision owner to prepare an update.
3. For decisions with notable outcomes:
   - Flag for the decision quality review (workflow 12).
   - Note whether the outcome confirms or challenges the original rationale.
4. Update the decision log with any annotations.
...
3. **Succession Register**: Quick check.
   - Any leadership changes or announcements that affect the register?
   - Any development plans that need attention?
4. **Partnership Portfolio**: Quick check.
   - Any partnerships approaching renewal or expiration?
   - Any KPI alerts?
...
2. Schedule 1:1 conversations with any stakeholder who needs attention.
3. Note any relationship maintenance items for the coming month.
...
- Updated next-meeting agenda (or confirmation it is on track).
- Decision log annotations and review schedule.
- Risk register monthly update.
...
| Activity | Duration |
|---|---|
| Agenda review | 30 minutes |
| Decision registry review | 30 minutes |
| Registry updates | 30 minutes |
| Stakeholder pulse | 20 minutes |
| Planning next month | 20 minutes |
| **Total** | **~2.5 hours** |

Scheduled: first week of each month. Block a single morning or split across two sessions.

## Metrics

| Metric | Target |
|---|---|
| Monthly review completion | 12/12 months per year |
| Decision log freshness | All decisions from past 90 days reviewed |
| Overdue action items | ≤10 % of total open items |
| Risk register freshness | No risk unreviewed for >60 days |
| Time to complete review | ≤3 hours |
| Follow-up items actioned | 100 % of items from prior month's review addressed |
