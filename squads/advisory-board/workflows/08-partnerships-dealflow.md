# 08 — Partnerships & Dealflow

## Overview

A structured process for evaluating, negotiating, and governing strategic partnerships — from inbound deal evaluation through term negotiation, risk assessment, and ongoing governance. Ensures the board adds value at decision points without creating bottlenecks.

## Trigger

- Inbound partnership proposal exceeding the delegated authority threshold.
- Outbound strategic initiative requiring a partner (distribution, technology, co-development).
- Existing partnership up for renewal or renegotiation.
- Board or strategy refresh identifies partnership as a strategic priority.
...
### Phase 1 — Evaluation (Days 1-10)

1. Capture the opportunity in the deal pipeline tracker:
   - Partner name, type (technology, distribution, co-development, licensing, JV).
...
1. If pursuing, strategic-advisor drafts the term sheet framework:
   ...
   - Governance: joint steering committee, decision rights, escalation.
...
6. Record the decision with rationale and conditions in the decision log.
...
- Deal pipeline tracker entry.
- Partnership evaluation scorecard.
- Risk assessment (preliminary and final).
- Financial model with final terms.
- Board decision memo.
- Signed partnership agreement.
- Partnership KPI dashboard.
- Quarterly partnership portfolio summary.
...
| Term sheet framework drafted | Day 15 |
| Negotiation complete | Day 30 |
| Final risk assessment | Day 32 |
| Board decision | Day 35 |
| Governance framework live | Day 45 |

## Metrics

| Metric | Target |
|---|---|
| Evaluation turnaround | ≤10 days from opportunity capture |
| Board decision turnaround | ≤5 days from package submission |
| Partnership KPI review cadence | Quarterly, no exceptions |
| Partnership value realization | ≥70 % of projected value at 12-month review |
| Risk reassessment cadence | Semi-annual |
| Termination decision speed | ≤30 days from trigger event |
